...
import { Plus, Pencil, Phone, Users, CircleDot, Trash2 } from "lucide-react";
...
export function CirclesPageClient({
  ...
  return (
    <main className="p-(--space-4) md:p-(--space-8) max-w-[1000px] mx-auto">
      ...
      <div className="space-y-(--space-3) mb-(--space-8)">
        {circles.length === 0 && (
          <Card>
        ...
        {circles.map((circle) => (
          <Card key={circle.id} className="flex items-center justify-between gap-(--space-3) flex-wrap">
            <div className="flex items-center gap-(--space-3)">
              <div className="flex h-10 w-10 items-center justify-center rounded-(--radius-sm) bg-brand-soft text-brand-hover shrink-0">
                <CircleDot size={18} />
              </div>
              <div>
